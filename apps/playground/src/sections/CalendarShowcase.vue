  ...
  <div style="display: flex; flex-direction: column; gap: 24px">
    <section class="section">
      ...
      <p style="color: var(--iris-muted); font-size: 14px; margin: 0 0 16px">
        Google Calendar-lite widget from <code>@iris-ui-kit/plugin-calendar</code>.
      </p>
...
import { IrisEventCalendar, type CalendarEvent } from '@iris-ui-kit/plugin-calendar/vue'
