...
import { IrisLineChart, IrisBarChart, IrisSparkline } from '@iris-ui/plugin-charts/react'
import { IrisButton, IrisCard } from '@iris-ui/react'
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      <section className="section">
        ...
        <p style={{ color: 'var(--iris-muted)', fontSize: 14, margin: '0 0 16px' }}>
          Zero-dependency, token-themed SVG charts from <code>@iris-ui/plugin-charts</code>. Charts
          inherit the active theme via CSS variables — try switching skins above.
        </p>
