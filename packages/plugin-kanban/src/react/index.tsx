...
export function IrisKanban({ config, className, style }: IrisKanbanProps) {
  ...
  const onCardPointerMove = (cardId: string) => (e: React.PointerEvent<HTMLElement>) => {
    ...
    if (sortable.tryStart(e.clientX, e.clientY)) {
      ...
      dragRects.current = collectRects(root, 'data-iris-kanban-column')
    }
          ...
          >
            ...
            >
              ...
              <span
                ...
                style={{ fontSize: '0.8em', color: 'var(--iris-muted, #64748b)' }}
              >
                {col.cards.length}
              ...
              >
                ...
                {card.description && (
                  <span
                    ...
                    style={{ fontSize: '0.85em', color: 'var(--iris-muted, #64748b)' }}
                  >
                    {card.description}
                  </span>
                )}
