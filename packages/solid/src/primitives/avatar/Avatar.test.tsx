...
describe('@iris-ui/solid IrisAvatar', () => {
  ...
  it('fallbackContent node wins over initials', () => {
  ...
  it('size sm/md/lg maps to 24/32/48', () => {
    ...
    const { container } = render(() => <IrisAvatar size={size()} />)
  ...
  it('shape="square" disables circle border-radius', () => {
    ...
    const wrapper = container.querySelector('[data-iris-avatar]')!
    expect(wrapper.getAttribute('data-iris-avatar-shape')).toBe('square')
