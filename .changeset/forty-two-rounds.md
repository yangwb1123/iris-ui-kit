...
'@iris-ui-kit/mcp': minor
'@iris-ui-kit/cli': minor
'@iris-ui-kit/eslint-plugin': minor
'@iris-ui-kit/plugin-locale-zh': minor
'@iris-ui-kit/plugin-editor': minor
'@iris-ui-kit/plugin-pro-table': minor
'@iris-ui-kit/plugin-charts': minor
'@iris-ui-kit/plugin-form-builder': minor
'@iris-ui-kit/plugin-notifications': minor
'@iris-ui-kit/plugin-admin': minor
'@iris-ui-kit/plugin-calendar': minor
'@iris-ui-kit/plugin-dashboard': minor
'@iris-ui-kit/plugin-kanban': minor
'@iris-ui-kit/plugin-markdown': minor
'@iris-ui-kit/plugin-query-builder': minor
---
