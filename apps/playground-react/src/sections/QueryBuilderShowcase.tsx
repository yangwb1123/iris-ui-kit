...
import {
  ...
  IrisQueryBuilder,
  type FilterRule,
} from '@iris-ui/plugin-query-builder/react'
import type { QueryColumn } from '@iris-ui/plugin-query-builder/react'
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      <section className="section">
        ...
        <p style={{ color: 'var(--iris-muted)', fontSize: 14, margin: '0 0 16px' }}>
          Visual filter builder from <code>@iris-ui/plugin-query-builder</code>. Add rules, pick
