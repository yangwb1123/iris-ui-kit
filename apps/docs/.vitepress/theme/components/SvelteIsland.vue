...
// SvelteIsland — mounts a single @iris-ui-kit/svelte primitive into its own root via the
...
// `.svelte` source that @iris-ui-kit/svelte ships gets compiled.) Combined with the
