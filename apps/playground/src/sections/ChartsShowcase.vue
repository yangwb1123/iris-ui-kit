  ...
  <div style="display: flex; flex-direction: column; gap: 24px">
    <section class="section">
      ...
      <p style="color: var(--iris-muted); font-size: 14px; margin: 0 0 16px">
        Token-themed SVG charts from <code>@iris-ui-kit/plugin-charts</code>. Charts inherit the
        active theme via CSS variables — try switching skins.
      </p>
...
import { IrisLineChart, IrisBarChart, IrisSparkline } from '@iris-ui-kit/plugin-charts/vue'
