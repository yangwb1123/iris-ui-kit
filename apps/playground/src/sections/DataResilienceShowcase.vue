  ...
  <div style="display: flex; flex-direction: column; gap: 24px">
    <section class="section">
      ...
      <p style="color: var(--iris-muted); font-size: 14px; margin: 0 0 16px">
        Framework-agnostic resilience primitives from <code>@iris-ui-kit/core</code>. Each demo
        below runs live in this page.
      </p>
...
import { createResilientFetcher, createOutbox, createDisposableScope } from '@iris-ui-kit/core'
