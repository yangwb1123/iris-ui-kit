import { IrisAdminApp, type AdminAppSchema } from '@iris-ui/plugin-admin/react'
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      <section className="section">
        ...
        <p style={{ color: 'var(--iris-muted)', fontSize: 14, margin: '0 0 16px' }}>
          ...
          <code>@iris-ui/plugin-admin</code>. Each page is a paginated table with sorting, backed by
          the same data engine as IrisTable.
        </p>
