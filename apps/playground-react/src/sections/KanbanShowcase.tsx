import { IrisKanban, type KanbanConfig } from '@iris-ui/plugin-kanban/react'
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      <section className="section">
        ...
        <p style={{ color: 'var(--iris-muted)', fontSize: 14, margin: '0 0 16px' }}>
          Drag-and-drop Kanban board from <code>@iris-ui/plugin-kanban</code>. Cards can be moved
          between columns; WIP-limited columns refuse cards when at capacity.
        </p>
