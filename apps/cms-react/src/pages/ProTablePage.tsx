import { createProTableStore, type ProTableColumn } from '@iris-ui/plugin-pro-table/core'
...
/**
 * ProTable demo page — showcases @iris-ui/plugin-pro-table with
  ...
  return (
    <div data-page="pro-table">
      ...
      <p style={{ margin: '0 0 16px', color: 'var(--iris-muted)', fontSize: 14 }}>
        CRUD data table powered by <code>@iris-ui/plugin-pro-table</code> with client-side sorting,
        filtering, inline editing, and column resize.
      </p>
