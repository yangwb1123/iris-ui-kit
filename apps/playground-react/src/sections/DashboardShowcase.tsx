import { IrisDashboard, type DashboardConfig } from '@iris-ui-kit/plugin-dashboard/react'
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      <section className="section">
        ...
        <p style={{ color: 'var(--iris-muted)', fontSize: 14, margin: '0 0 16px' }}>
          Draggable dashboard grid from <code>@iris-ui-kit/plugin-dashboard</code>. Widgets can be
          moved by dragging their header (desktop) or via touch.
        </p>
