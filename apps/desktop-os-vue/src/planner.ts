...
/**
 * The Assistant's planner (Vue). The framework-agnostic brain — `fuzzyPlanner`,
 * `createLlmPlanner`, and the `Planner`/`ModelCall`/`ToolChoice` contracts — lives
 * in `@iris-ui-kit/core/commands` and is shared by all four desktop shells
