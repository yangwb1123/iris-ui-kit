 ...
 *
 * Ensures every JS entry in @iris-ui/react/dist starts with the 'use client'
...
export async function run() {
  ...
  console.log(`\nRSC 'use client' directive (@iris-ui/${fw})\n` + '─'.repeat(48))
  ...
  console.log(`\n✓ All @iris-ui/${fw} entries are client-boundary safe\n`)
  return 0
}