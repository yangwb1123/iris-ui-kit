...
import { IrisEventCalendar, type CalendarEvent } from '@iris-ui-kit/plugin-calendar/react'
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      <section className="section">
        ...
        <p style={{ color: 'var(--iris-muted)', fontSize: 14, margin: '0 0 16px' }}>
          Google Calendar-lite widget from <code>@iris-ui-kit/plugin-calendar</code>. Months and
          events are fully interactive.
        </p>
