...
/**
 * Generate a complete form-builder schema from simple field descriptors.
 * Returns the schema object and a ready-to-use code snippet.
 */
export function generateFormSchema(
  ...
  const react = `import { IrisFormBuilder } from '@iris-ui/plugin-form-builder/react'
...
import { IrisFormBuilder, type FormSchema } from '@iris-ui/plugin-form-builder/vue'
