...
{#if open}
  <div
    ...
    style="{floating.floatingStyles}; background: var(--iris-foreground); color: var(--iris-background); padding: 4px 8px; border-radius: var(--iris-radius-sm, 4px); font-size: var(--iris-font-size-xs, 12px); line-height: 1.4; max-width: 240px; pointer-events: none; z-index: 1100; {rest.style ??
      ''}"
  >
    {#if contentSlot}
      {@render contentSlot()}
