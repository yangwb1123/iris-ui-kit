...
export const zhCNMessages: Record<string, string> = {
  ...
  'table.copyValue': '复制值',
  'table.clearCell': '清空',
  'table.formatNumber': '数字格式（2 位）',
  'table.formatUpper': '文本大写',
  'table.pinLeft': '固定左',
  'table.unpin': '取消固定',
  'table.annotate': '添加批注',
  'table.annotate.edit': '编辑批注',
  'table.annotate.remove': '删除批注',
  'table.annotate.save': '保存',
  ...
  'table.charCount': '{count} 字',
  'table.charCount.range': '{count} 个单元格',
  'table.charCount.rangeSum': '合计 {sum}',
