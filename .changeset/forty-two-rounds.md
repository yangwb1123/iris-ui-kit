...
'@iris-ui/manifest': minor
'@iris-ui/mcp': minor
'@iris-ui/cli': minor
'@iris-ui/eslint-plugin': minor
'@iris-ui/plugin-locale-zh': minor
'@iris-ui/plugin-editor': minor
'@iris-ui/plugin-pro-table': minor
'@iris-ui/plugin-charts': minor
'@iris-ui/plugin-form-builder': minor
'@iris-ui/plugin-notifications': minor
'@iris-ui/plugin-admin': minor
'@iris-ui/plugin-calendar': minor
'@iris-ui/plugin-dashboard': minor
'@iris-ui/plugin-kanban': minor
'@iris-ui/plugin-markdown': minor
'@iris-ui/plugin-query-builder': minor
---

### Data Resilience Layer (all 9 primitives wired into real consumers)
...
- Form Builder (`@iris-ui/plugin-form-builder`) demo added to all 4 CMS apps (React/Vue/Solid/Svelte)
...
- Chinese i18n (`@iris-ui/plugin-locale-zh`) enabled in CMS React with `locale="zh-CN"`
