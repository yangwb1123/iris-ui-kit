/**
 * Framework-agnostic color conversion helpers (C-layer **material**) — the
 * single source behind ColorPicker across all four frameworks, which each
 * carried a byte-identical copy. Pure math: HSV↔RGB, RGB↔HEX(+alpha), and the
 * HSVA/RGBA bundles the picker stores. All channels normalized as noted.
 */
