...
import { IrisFormBuilder, type FormSchema } from '@iris-ui-kit/plugin-form-builder/solid'
...
/**
 * Form Builder demo page for Solid CMS — same schema, same semantics as React/Vue.
 */
export function FormBuilderPage() {
  const [submitted, setSubmitted] = createSignal<Record<string, unknown> | null>(null)
